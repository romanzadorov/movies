...
export class AppService {
  ...
  getMovies() {
    ...
    const urlObj = {
      latest: `https://api.themoviedb.org/3/discover/movie?api_key=abe23ad125116fdc6637848dc070b68e&primary_release_date.gte=2019-07-01`,
      popular: `https://api.themoviedb.org/3/discover/movie?sort_by=vote_average.desc&api_key=abe23ad125116fdc6637848dc070b68e&primary_release_date.gte=2019-07-01`,
      comingSoon: `https://api.themoviedb.org/3/movie/upcoming?api_key=abe23ad125116fdc6637848dc070b68e&page=1`,
      criticalReview: `https://api.themoviedb.org/3/movie/top_rated?api_key=abe23ad125116fdc6637848dc070b68e&page=1&&primary_release_year=2019`
    };
    const urlObservables = Object.keys(urlObj).map(key => {
      const url = [urlObj[key], formattedIds, formattedGenreIds, formattedLanguages].join('&');
