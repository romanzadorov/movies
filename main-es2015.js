...
/* harmony import */ var _movies_movies_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movies/movies.component */ "./src/app/movies/movies.component.ts");
/* harmony import */ var ngx_useful_swiper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-useful-swiper */ "./node_modules/ngx-useful-swiper/fesm2015/ngx-useful-swiper.js");
...
let AppService = class AppService {
    ...
    getMovies() {
        ...
        const languageOptions = session.language.map((item) => item.preferenceKey) || [];
...
let MovieDetailComponent = class MovieDetailComponent {
    constructor(activatedRoute, appService, _sanitizer, dialog) {
    ...
    addToFavorites(movieDetails) {
        ...
        if (favoriteMovies && favoriteMovies.length > 0) {
            ...
            let existingMovie = favoriteMovies.find((movie) => movie["id"] === movieDetails.id);
    ...
    openVideoModal() {
        ...
        const dialogRef = this.dialog.open(_video_dialog_video_dialog_component__WEBPACK_IMPORTED_MODULE_6__["VideoDialogComponent"], dialogConfig);
...
let MoviesGridComponent = class MoviesGridComponent {
    constructor(appService, activatedRoute, router) {
        this.appService = appService;
        this.activatedRoute = activatedRoute;
        this.router = router;
...
MoviesGridComponent.ctorParameters = () => [
...
let SwiperWrapperComponent = class SwiperWrapperComponent {
    constructor(appService, router) {
        this.appService = appService;
        this.router = router;
        this.config = {
...
SwiperWrapperComponent.ctorParameters = () => [
    { type: _app_service__WEBPACK_IMPORTED_MODULE_3__["AppService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
VideoDialogComponent.ctorParameters = () => [
